...
if ((scaling.window.w == -1) or (scaling.window.h == -1) or (scaling.menu.w == -1) or (scaling.menu.h == -1)) then
    ...
    theme.SingleDisplay1.DefaultY = scaling.window.h - (scaling.scale_height(150) + 2*theme.SingleDisplay1.PanelHeight);
    theme.DoubleDisplay1.DefaultX = (scaling.window.w - theme.DoubleDisplay1.PanelWidth) / 2;
    theme.DoubleDisplay1.DefaultY = scaling.window.h - (scaling.scale_height(150) + 2*theme.DoubleDisplay1.PanelHeight);
    theme.SingleDisplay2.DefaultX = (scaling.window.w - theme.SingleDisplay2.PanelWidth) / 2;
    theme.SingleDisplay2.DefaultY = scaling.window.h - (scaling.scale_height(150) + theme.SingleDisplay2.PanelHeight);
    theme.DoubleDisplay2.DefaultX = (scaling.window.w - theme.DoubleDisplay2.PanelWidth) / 2;
    theme.DoubleDisplay2.DefaultY = scaling.window.h - (scaling.scale_height(150) + theme.DoubleDisplay2.PanelHeight);
end
